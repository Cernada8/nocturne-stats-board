        ...
        <div className="max-w-7xl mx-auto w-full space-y-6 sm:space-y-8 md:space-y-10 lg:space-y-12">
          ...
          {isLoadingStats ? (
            ...
            <div className="animate-fade-in w-full">
              {/* Mobile: Vertical Stack - optimizado */}
              <div className="flex flex-col gap-6 sm:hidden px-2 py-6">
                {/* Alcance Total - Principal */}
                <div className="text-center space-y-1.5">
                  ...
                  <p className="text-sm font-bold text-foreground">Alcance Total</p>
                </div>
                
                {/* Grid 2 columnas para las otras métricas */}
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center space-y-1.5">
                    ...
                    <p className="text-xs font-bold text-foreground leading-tight">Menciones<br/>Totales</p>
                  </div>
                  ...
                  <div className="text-center space-y-1.5">
                    ...
                    <p className="text-xs font-bold text-foreground leading-tight">Autores<br/>Únicos</p>
                  </div>
                </div>
              </div>
              ...
              <div className="hidden sm:flex lg:hidden items-center justify-center gap-6 md:gap-12 py-10 md:py-16 px-4">
                <div className="text-center space-y-2 flex-shrink-0">
                  ...
                  <p className="text-xs md:text-sm font-bold text-foreground whitespace-nowrap">Menciones Totales</p>
                </div>
                ...
                <div className="text-center space-y-2 flex-shrink-0">
                  ...
                  <p className="text-base md:text-lg font-bold text-foreground whitespace-nowrap">Alcance Total</p>
                </div>
                ...
                <div className="text-center space-y-2 flex-shrink-0">
                  ...
                  <p className="text-xs md:text-sm font-bold text-foreground whitespace-nowrap">Autores Únicos</p>
                </div>
              </div>
              ...
              <div className="hidden lg:flex items-center justify-center gap-16 xl:gap-32 py-16 xl:py-24">
                <div className="text-center space-y-3 min-w-[200px] xl:min-w-[250px]">
                  ...
                  <p className="text-sm xl:text-base font-bold text-foreground">Menciones Totales</p>
                </div>
                ...
                <div className="text-center space-y-3 min-w-[300px] xl:min-w-[400px]">
                  ...
                  <p className="text-xl xl:text-2xl font-bold text-foreground">Alcance Total</p>
                </div>
                ...
                <div className="text-center space-y-3 min-w-[200px] xl:min-w-[250px]">
                  ...
                  <p className="text-sm xl:text-base font-bold text-foreground">Autores Únicos</p>
                </div>
              </div>
            </div>
          ) : null}
          ...
          <div className="space-y-2 sm:space-y-3 w-full">
            <h2 className="text-sm sm:text-base md:text-lg font-semibold text-foreground/80 px-1">Tópicos</h2>
            {isLoadingAlerts ? (
