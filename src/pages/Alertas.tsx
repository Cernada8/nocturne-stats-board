...
import YouTubeAlertsTab from '@/components/YoutubeAlertsTab';
import {
    Loader2,
    Bell,
    Plus,
            ...
            <div className="flex-1 overflow-y-auto relative z-10 scrollbar-thin scrollbar-thumb-slate-700/50 scrollbar-track-slate-900/50 hover:scrollbar-thumb-slate-600/70">
                <div className="p-3 sm:p-4 md:p-6 lg:p-8 max-w-7xl mx-auto space-y-3 sm:space-y-4 md:space-y-6">
                    ...
                    <Tabs defaultValue="personalizadas" className="w-full">
                        <TabsList className="glass-effect border border-white/10 mb-6 w-full sm:w-auto">
                            <TabsTrigger 
                                value="personalizadas" 
                                className="data-[state=active]:bg-white/10 flex-1 sm:flex-initial"
                            >
                        ...
                        {/* PESTAÑA DE ALERTAS PERSONALIZADAS */}
                            ...
                            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                                <Dialog open={isDialogOpen} onOpenChange={(open) => {
                                    ...
                                    <DialogTrigger asChild>
                                        <Button className="glass-effect border border-white/10 hover:bg-white/10 text-white ml-auto">
