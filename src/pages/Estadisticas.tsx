...
import { LogOut, TrendingUp, Smile, Users, Database, Globe } from 'lucide-react';
...
const Estadisticas = () => {
  ...
  const estadisticasCards = [
    {
      ...
      title: 'Alcance',
      icon: TrendingUp,
      description: 'Análisis de alcance temporal',
    ...
    },
    {
      ...
      title: 'Género y Edad',
      icon: Users,
      description: 'Demografía de audiencia',
  ...
  const handleCardClick = (estadisticaId: string) => {
    navigate(`/${estadisticaId}`);
  };
      ...
      <div className="flex-1 p-3 sm:p-4 md:p-6 lg:p-6 overflow-y-auto relative z-10">
        <div className="max-w-7xl mx-auto space-y-4 sm:space-y-6">
          ...
          <div className="hidden lg:grid grid-cols-4 grid-rows-2 gap-4 h-[calc(100vh-280px)]">
            ...
            >
              <div className={`absolute inset-0 bg-gradient-to-br ${estadisticasCards[0].gradient} opacity-0 group-hover:opacity-100 transition-opacity duration-500`}></div>
              <div className={`absolute inset-0 blur-3xl opacity-0 group-hover:opacity-50 transition-opacity duration-500 ${estadisticasCards[0].glow}`}></div>
              ...
              <div className="relative flex flex-col items-center justify-center text-center h-full space-y-6">
                <div className="relative">
                  ...
                  <div className="relative p-6 bg-gradient-to-br from-purple-500/10 to-pink-500/10 border border-purple-500/20 rounded-2xl group-hover:border-purple-500/50 transition-all duration-500 group-hover:scale-110">
                    <TrendingUp className="w-16 h-16 text-white drop-shadow-[0_0_10px_rgba(168,85,247,0.5)]" />
                  </div>
                </div>
                <div>
                  <h3 className="text-3xl font-bold text-white mb-2 group-hover:text-purple-300 transition-colors duration-300">Alcance</h3>
                  <p className="text-base text-white/70">Análisis de alcance temporal</p>
                </div>
              </div>
            </Card>
            ...
            {/* Sentimiento */}
            <Card
              onClick={() => handleCardClick('sentimiento')}
            ...
            >
              <div className={`absolute inset-0 bg-gradient-to-br ${estadisticasCards[1].gradient} opacity-0 group-hover:opacity-100 transition-opacity duration-500`}></div>
              <div className={`absolute inset-0 blur-2xl opacity-0 group-hover:opacity-50 transition-opacity duration-500 ${estadisticasCards[1].glow}`}></div>
              ...
              <div className="relative flex flex-col items-center justify-center text-center h-full space-y-4">
                <div className="relative">
                  ...
                  <div className="relative p-4 bg-gradient-to-br from-cyan-500/10 to-blue-500/10 border border-cyan-500/20 rounded-2xl group-hover:border-cyan-500/50 transition-all duration-500 group-hover:scale-110">
                    <Smile className="w-10 h-10 text-white drop-shadow-[0_0_8px_rgba(6,182,212,0.5)]" />
                  </div>
                </div>
                <div>
                  <h3 className="text-xl font-bold text-white mb-1 group-hover:text-cyan-300 transition-colors duration-300">Sentimiento</h3>
                  <p className="text-xs text-white/70">Análisis de sentimientos</p>
                </div>
              </div>
            </Card>
            ...
            {/* Género y Edad */}
            <Card
              onClick={() => handleCardClick('genero-edad')}
              className="col-span-1 row-span-1 glass-card p-6 cursor-pointer transition-all duration-500 hover:bg-white/5 border border-white/10 group relative overflow-hidden"
            >
              <div className={`absolute inset-0 bg-gradient-to-br ${estadisticasCards[2].gradient} opacity-0 group-hover:opacity-100 transition-opacity duration-500`}></div>
              <div className={`absolute inset-0 blur-2xl opacity-0 group-hover:opacity-50 transition-opacity duration-500 ${estadisticasCards[2].glow}`}></div>
              ...
              <div className="relative flex flex-col items-center justify-center text-center h-full space-y-4">
                <div className="relative">
                  ...
                  <div className="relative p-4 bg-gradient-to-br from-emerald-500/10 to-teal-500/10 border border-emerald-500/20 rounded-2xl group-hover:border-emerald-500/50 transition-all duration-500 group-hover:scale-110">
                    <Users className="w-10 h-10 text-white drop-shadow-[0_0_8px_rgba(16,185,129,0.5)]" />
                  </div>
                </div>
                <div>
                  <h3 className="text-xl font-bold text-white mb-1 group-hover:text-emerald-300 transition-colors duration-300">Género y Edad</h3>
                  <p className="text-xs text-white/70">Demografía de audiencia</p>
                </div>
              </div>
            </Card>
            ...
            <Card
              ...
              className="col-span-1 row-span-1 glass-card p-6 cursor-pointer transition-all duration-500 hover:bg-white/5 border border-white/10 group relative overflow-hidden"
            >
              <div className={`absolute inset-0 bg-gradient-to-br ${estadisticasCards[3].gradient} opacity-0 group-hover:opacity-100 transition-opacity duration-500`}></div>
              <div className={`absolute inset-0 blur-2xl opacity-0 group-hover:opacity-50 transition-opacity duration-500 ${estadisticasCards[3].glow}`}></div>
              ...
              <div className="relative flex flex-col items-center justify-center text-center h-full space-y-4">
                <div className="relative">
                  ...
                  <div className="relative p-4 bg-gradient-to-br from-orange-500/10 to-red-500/10 border border-orange-500/20 rounded-2xl group-hover:border-orange-500/50 transition-all duration-500 group-hover:scale-110">
                    <Database className="w-10 h-10 text-white drop-shadow-[0_0_8px_rgba(249,115,22,0.5)]" />
                  </div>
                </div>
                <div>
                  <h3 className="text-xl font-bold text-white mb-1 group-hover:text-orange-300 transition-colors duration-300">Fuentes</h3>
                  <p className="text-xs text-white/70">Distribución por fuentes</p>
                </div>
              </div>
            </Card>
            ...
            <Card
              ...
              className="col-span-1 row-span-1 glass-card p-6 cursor-pointer transition-all duration-500 hover:bg-white/5 border border-white/10 group relative overflow-hidden"
            >
              <div className={`absolute inset-0 bg-gradient-to-br ${estadisticasCards[4].gradient} opacity-0 group-hover:opacity-100 transition-opacity duration-500`}></div>
              <div className={`absolute inset-0 blur-2xl opacity-0 group-hover:opacity-50 transition-opacity duration-500 ${estadisticasCards[4].glow}`}></div>
              ...
              <div className="relative flex flex-col items-center justify-center text-center h-full space-y-4">
                <div className="relative">
                  ...
                  <div className="relative p-4 bg-gradient-to-br from-indigo-500/10 to-violet-500/10 border border-indigo-500/20 rounded-2xl group-hover:border-indigo-500/50 transition-all duration-500 group-hover:scale-110">
                    <Globe className="w-10 h-10 text-white drop-shadow-[0_0_8px_rgba(99,102,241,0.5)]" />
                  </div>
                </div>
                <div>
                  <h3 className="text-xl font-bold text-white mb-1 group-hover:text-indigo-300 transition-colors duration-300">Países</h3>
