...
import { LogOut, Bell, User, Database, Globe, Languages } from 'lucide-react';
      ...
      <div className="flex-1 p-6 overflow-y-auto relative z-10">
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div>
            ...
            <p className="text-white/70">Selecciona un tipo de ranking para visualizar</p>
          </div>

          {/* Ranking Cards - Bento Grid */}
              ...
              <div className="relative flex flex-col items-center justify-center text-center h-full space-y-6">
                <div className="relative">
                  ...
                  <div className="relative p-6 bg-gradient-to-br from-purple-500/10 to-pink-500/10 border border-purple-500/20 rounded-2xl group-hover:border-purple-500/50 transition-all duration-500 group-hover:scale-110">
                    <Bell className="w-16 h-16 text-white drop-shadow-[0_0_10px_rgba(168,85,247,0.5)]" />
                  </div>
                </div>
                <div>
                  <h3 className="text-3xl font-bold text-white mb-2 group-hover:text-purple-300 transition-colors duration-300">Alertas</h3>
                  <p className="text-base text-white/70">Ranking de alertas más activas</p>
                </div>
              </div>
            </Card>
